...
// discoverModelProperties doesn't contain any information about indexes,
// so this allows accessing index information.
PostgreSQL.prototype.discoverModelIndexes = function (model, cb) {
  getTableStatus.call(this, model, function(err, fields, indexes) {
    var indexData = {};
